...
public class ByosDataGridProto
  extends Table
{
  ...
  public int[] filtrables;
  public ByosFilter[] tipoFiltro;
  public PropertyChangeSupport support = new PropertyChangeSupport(this);
  public boolean multiSelect;
  
  public ByosDataGridProto()
  {
    setImmediate(true);
  ...
  public void initDatagridByos(ArrayList AL, Object c, String[] columnasVisible, ByosFilter[] tipoFiltro, String[] columnasCabecera, Class[] columnasTipo, boolean[] editable, boolean multiSelect)
  {
    if (columnasVisible.length == columnasCabecera.length)
    {
      ...
      for (int i = 0; i < columnasVisible.length; i++) {
        if (editable[i] != true) {
          addGeneratedColumn(columnasVisible[i], new ColumnaEditable(columnasTipo[i]));
        }
      }
      setPageLength(50);
      setSelectable(true);

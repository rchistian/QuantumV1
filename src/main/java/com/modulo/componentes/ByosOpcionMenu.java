...
public class ByosOpcionMenu extends MenuBar implements Serializable {
	...
	public ByosOpcionMenu(String[][] Menu, String Titulo, int Icono, MenuBar.Command Comando, String Forma){
	    this.Titulo = Titulo;
	    this.Icono = Icono;

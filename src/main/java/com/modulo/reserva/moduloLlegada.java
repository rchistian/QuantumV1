...
public class moduloLlegada  extends VerticalLayout  implements Serializable{
    ...
    public moduloLlegada(String xNumeroDocuemto, moduloReserva01 WindowsRaiz, String EstiloCSS) {
